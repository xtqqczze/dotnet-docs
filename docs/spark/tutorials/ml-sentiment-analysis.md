...
1. Open the *Program.cs* file for **MLSparkModelML.ConsoleApp**. This file was auto-generated by Model Builder. Delete the `using` statements, the contents of the Main() method, and the `CreateSingleDataSample` region.
